...
public class RegisterServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println(religion + category + amount);
...
//            out.println("<h1>RESULT: " + result + "</h1>");
            ...
            for(int i = 1;i<=Integer.parseInt(arrResult[0][0]);i++){
                out.println("<h1 class=\"result-item\">Scholarship: <span> <a href=" + arrResult[i][3] +">"+ arrResult[i][0] + "</span></h1>");
                out.println("<h3 style=\"align-items: center; text-align:center;\" class=\"result-item\">Apply Link <a href=\"" + arrResult[i][1] + "\">" + "</a></h3>");
